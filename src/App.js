  ...
  return (
    <Fragment>
      ...
      <Switch>
        ...
        <Route exact path ='/home' component={() => <Home favourites={this.props.favourites} houses={this.props.houses} message= {this.props.message} postFavourite={this.props.postFavourite} deleteFavourite={this.props.deleteFavourite}/>} />
